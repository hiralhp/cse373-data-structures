...
public class TestDoubleLinkedList extends BaseTest {
    ...
    */
    ...
    //begin delete() test additions
    
    @Test()
    public void testDeleteBasic() {
        IList<String> list = makeBasicList();
        //removes from middle of the list
        list.delete(1);
        this.assertListMatches(new String[] {"a", "c"}, list);
        assertEquals(2, list.size()); //checks size update
    }
    ...
    public void testDeleteBeginning() {
        ...
        assertEquals(1, list.size()); //checks size update
        
        list.delete(0);
        this.assertListMatches(new String[] {}, list);
        assertEquals(0, list.size()); //checks size update
        
    }
    @Test(timeout=10*SECOND)
    public void testDeleteNearFront() {
        IList<String> list = makeBasicList();
        list.add("d");
        list.add("e");
        //removes from beginning of the list
        ...
        assertEquals(4, list.size()); //checks size update
        list.delete(1);
        this.assertListMatches(new String[] {"a", "d", "e"}, list);
        assertEquals(3, list.size()); //checks size update
        
    }
    @Test(timeout=10*SECOND)
    public void testAddNearFrontIsEfficient() {
        IList<String> list = makeBasicList();
        for(int i = 0; i <10000; i++) {
            list.add(i+"hi");
        }
        ...
        assertEquals(6003, list.size());
        
    }
    
    @Test(timeout=10*SECOND)
    public void testDeleteNearEnd() {
        IList<String> list = makeBasicList();
        list.add("d");
        list.add("e");
        list.add("f");
        //removes from beginning of the list
        list.delete(3);
        this.assertListMatches(new String[] {"a", "b", "c", "e", "f"}, list);
        assertEquals(5, list.size()); //checks size update
        list.delete(3);
        this.assertListMatches(new String[] {"a", "b", "c", "f"}, list);
        assertEquals(4, list.size()); //checks size update
     }
