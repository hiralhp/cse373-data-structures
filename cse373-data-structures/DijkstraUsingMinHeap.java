...
public class DijkstraUsingMinHeap {
   ...
   static class Graph {
      ...
      public void dijkstra_GetMinDistances(int sourceVertex, Map<Integer, Integer> vertToVal, int ammount){
      ...
      //          //create heapNode for all the vertices
            ...
            for (int i = 0; i <list.size() ; i++) {
               ...
               if(SPT[destination]==false ) {
                  ...
                  if(currentKey>newKey){
                     ...
                     map.put(edge.destination, edge.source);
                  }
               }
         ...
         int currVert = map.get(ammount-1);
         while(currVert != 0){
         if(vertToVal.get(currVert) > currMax){
            currMax = vertToVal.get(currVert);
         }
           // System.out.println(vertToVal.get(currVert));
            currVert = map.get(currVert);
         }
   ...
   public static void main(String[] args) {
      int[][] maze = { {0, 10, 4, 29, 31}, {9, 16, 32, 1, 2}, {8, 12, 41, 71, 3},{7, 70, 4, 5, 0}};
           
   Map<Integer, Integer> vertToVal = new HashMap<Integer, Integer>();
      ...
      graph.dijkstra_GetMinDistances(sourceVertex, vertToVal,  ammount);
   }
}